...
Meal.create(name:'Vegetarian I',breakfast_meal:'Tapsilog',breakfast_drink:'Orange juice',lunch_meal:'Sisig ricebowl',lunch_drink:'Coke Classic',dinner_meal:'KFC 2 pc chicken', dinner_drink:'Iced tea',price:'300.00')
Meal.create(name:'Vegetarian II',breakfast_meal:'English breakfast',breakfast_drink:'Orange juice',lunch_meal:'Pork chop',lunch_drink:'Coke Classic',dinner_meal:'Sinangag na sinigang', dinner_drink:'Iced tea',price:'300.00')
Meal.create(name:'Vegetarian III',breakfast_meal:'Tapsilog',breakfast_drink:'Orange juice',lunch_meal:'Sisig ricebowl',lunch_drink:'Coke Classic',dinner_meal:'KFC 2 pc chicken', dinner_drink:'Iced tea',price:'300.00')
Meal.create(name:'Fil-Food I',breakfast_meal:'English breakfast',breakfast_drink:'Orange juice',lunch_meal:'Pork chop',lunch_drink:'Coke Classic',dinner_meal:'Sinangag na sinigang', dinner_drink:'Iced tea',price:'300.00')
...
Meal.create(name:'Fil-Food III',breakfast_meal:'English breakfast',breakfast_drink:'Orange juice',lunch_meal:'Pork chop',lunch_drink:'Coke Classic',dinner_meal:'Sinangag na sinigang', dinner_drink:'Iced tea',price:'300.00')
Meal.create(name:'European Dish',breakfast_meal:'English breakfast',breakfast_drink:'Orange juice',lunch_meal:'Pork chop',lunch_drink:'Coke Classic',dinner_meal:'Sinangag na sinigang', dinner_drink:'Iced tea',price:'300.00')
Meal.create(name:'Oriental Box',breakfast_meal:'English breakfast',breakfast_drink:'Orange juice',lunch_meal:'Pork chop',lunch_drink:'Coke Classic',dinner_meal:'Sinangag na sinigang', dinner_drink:'Iced tea',price:'300.00')