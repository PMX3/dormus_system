...
class ViolationsControllerTest < ActionController::TestCase
  ...
  test "should create violation" do
    assert_difference('Violation.count') do
      post :create, violation: { violation_description: @violation.violation_description, violation_points: @violation.violation_points, violation_type: @violation.violation_type }
    end
  ...
  test "should update violation" do
    patch :update, id: @violation, violation: { violation_description: @violation.violation_description, violation_points: @violation.violation_points, violation_type: @violation.violation_type }
    assert_redirected_to violation_path(assigns(:violation))
  end
